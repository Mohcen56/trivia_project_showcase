    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://mohcen.sentry.io/issues/?project=4510369269547088">Issues Page</a>.
